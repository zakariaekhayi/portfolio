    ...
    <hero id="Home">
      <div id="hero-section">
        ...
        <div id="navbar" style="position: relative;">
          ...
          <div class="nav-items">
            <ul id="navlist">
              <li class="li"><a class="a" style="text-decoration: none; " onmouseover="this.style.color=' #f18953'" onmouseout="this.style.color='white'"  href="Login.php">Log in</a></li>
              <li class="li"><a class="a" style="text-decoration: none; " onmouseover="this.style.color=' #f18953'" onmouseout="this.style.color='white'" href="sign_up.php">Sign up</a></li>
              <li>
      ...
      <div class="fifth-main-mid">
        ...
        <div class="fifth-mid-2">
          ...
          <h2 class="fifth-header3">
            What do you intend to do on <span class="spn3">Events?</span> <br />
            <input type="text" class="input3" placeholder="Tell us something" name="comment" />
          </h2>
         
        </div>
      </div>
      <button class="sign-btn" name="poster">Poster</button>
      </form>
      <p class="fifth-p1">
        Already have an account? &nbsp; <span class="spn4"><a href="Login.php">Log in</a></span>
      </p>
      <br />
      <p class="fifth-p2">
        Log in to view more events that suit your interests
      </p>
    </div>
